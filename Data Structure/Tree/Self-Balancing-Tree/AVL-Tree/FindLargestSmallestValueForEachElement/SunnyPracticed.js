...
tree.Inorder(root)
const value = 24
const searchedNode = tree.search(value, root, null)
const findMaxSmallest = (searchedNode.left) ?
    tree.maxValue(searchedNode.left) :
    (searchedNode.parent) ? searchedNode.parent.data :
        -1
console.log("Nearest Smallest Value Of " + value + " is " + findMaxSmallest)
