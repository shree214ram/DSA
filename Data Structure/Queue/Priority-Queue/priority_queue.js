...
class QElement {
  ...
  console.log('*****printPQueue the queue*****');
  
  console.log(priorityQueue.printPQueue()); 
    
  // prints Gourav 
  console.log('*****print front of  the queue*****');
  
  console.log(priorityQueue.front().element); 
    
  // pritns Sheru 
  console.log('*****print rear of  the queue*****');
  ...
  console.log('**dequeue the first priority element from the queue and print the dequeued element**');
  
  console.log(priorityQueue.dequeue().element); 
    
  // Adding another element to the queue 
  console.log('**Adding another element to the queue according to priority wise **');
